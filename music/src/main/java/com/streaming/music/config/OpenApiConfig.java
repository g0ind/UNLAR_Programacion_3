...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                ...
                .tags(List.of(
                        new Tag().name("Canciones").description("Operaciones CRUD y búsqueda de canciones"),
                        new Tag().name("Artistas").description("Gestión de artistas - CRUD completo"),
                        new Tag().name("Álbumes").description("Gestión de álbumes"),
                        new Tag().name("Productoras").description("Gestión de productoras/discográficas"),
                        new Tag().name("Estadísticas").description("Estadísticas avanzadas con Streams API")
                ))
